...
//   },
// });
// export function tips(content: string, time = 1000) {
...
export function useTips(tipsRef: any, content: string, time = 1000) {
  tipsRef.value && tipsRef.value.work(content, time);
}
