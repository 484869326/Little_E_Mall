<template>
  <view class="search">
    ...
    >
      <view class="search-content-input" @click="!isSearch && (isSearch = true)">
      ...
      <view class="search-content-list" v-if="searchList.length !== 0 && isSearch">
        <view
...
function handleItemClick(id: string, value: string) {
